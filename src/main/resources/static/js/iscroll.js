...
(function ($, window, document) {
  ...
  $.fn.iscroll.options = {
    ...
    /** The jQuery element in which data is added. Shown in the viewport. Must be specified. */
    $content: undefined,
    ...
    /** 
     * selector to extract content received when loading. By default all content is appended to $content
     * To unwrap received data, use value '> *'
     */
