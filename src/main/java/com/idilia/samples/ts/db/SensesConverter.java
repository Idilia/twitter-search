...
/**
 * Converter for serializing a list of senses as a string for storing in the
 * database and for recovering it.
 *
 * Implementation: Hibernate has a bug (HHH-8804) that prevents using List
 * <Sense> as the first argument of the template.
 */
@SuppressWarnings("rawtypes")
@Converter
public class SensesConverter implements AttributeConverter<List, String> {
  // public class SensesConverter implements AttributeConverter<List<Sense>,
  // String> {
